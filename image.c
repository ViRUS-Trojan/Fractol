...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/19 18:42:44 by vdelsie           #+#    #+#             */
/*   Updated: 2019/12/19 18:44:33 by vdelsie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** байт на пиксель
**
** ДАВАЙТЕ ОБЪЯВЛЯТЬ ЗДЕСЬ, ЧТО img-> bpp HENCEFORCE ВЫСТУПАЕТ ЗА БАЙТЫ НА ПИКСЕЛЬ!
*/
