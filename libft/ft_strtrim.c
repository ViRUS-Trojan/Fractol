...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/12/15 18:45:43 by vdelsie           #+#    #+#             */
/*   Updated: 2019/12/15 18:46:59 by vdelsie          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** malloc'd «trim» будет освобожден в какой-то момент. Если бы мы только вернулись
**	возвращение(""); тогда попытка освободить константный символ закончится плохо.
**
